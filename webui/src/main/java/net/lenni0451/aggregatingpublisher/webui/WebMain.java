...
import net.lenni0451.aggregatingpublisher.services.HttpBasicAuthenticator;
...
public class WebMain {
    ...
    public static void main(String[] args) {
        try {
            ...
            aggregatingPublisher.registerAuthentication(new HttpBasicAuthenticator(username, password));
